...
import { useIsMobile } from "@/popup/hooks/use-mobile.ts";
...
>(
  (
    ...
    // This state is used to filter the styles of the sidebar components.
      ...
      >
        ...
        >
          <div
            ...
            className="flex h-full w-full flex-col group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:border group-data-[variant=floating]:border-white/10 group-data-[variant=floating]:shadow-2xl"
            style={{
              background: "oklch(0.12 0.035 265 / 0.95)",
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      {state === "collapsed" ? <IconMenu2 /> : <IconX />}
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-1.5 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[side=left]:-right-3 group-data-[side=right]:-left-3 sm:flex",
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn(
        "flex flex-col gap-2 p-2 group-data-[collapsible=icon]:hidden",
        className,
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>svg]:size-4 [&>svg]:shrink-0 [&>span]:truncate [&>span]:group-data-[collapsible=icon]:hidden",
  {
    variants: {
      variant: {
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="h-4 flex-1 max-w-(--skeleton-width) bg-sidebar-accent-foreground/10 rounded-md"
